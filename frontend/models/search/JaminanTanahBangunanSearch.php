...
/**
 * JaminanTanahBangunanSearch represents the model behind the search form of `frontend\models\JaminanTanahBangunan`.
 */
class JaminanTanahBangunanSearch extends JaminanTanahBangunan
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = JaminanTanahBangunan::find();
