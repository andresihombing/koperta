...
/**
 * JaminanBangunanSearch represents the model behind the search form of `frontend\models\JaminanBangunan`.
 */
class JaminanBangunanSearch extends JaminanBangunan
{
    /**
     * {@inheritdoc}
     */
