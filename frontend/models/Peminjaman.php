 ...
 *
 * @property JaminanKendaraan $jaminanKendaraan
 * @property JaminanTanahBangunan $jaminanTanahBangunan
 */
class Peminjaman extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['jaminan_kendaraan_id'], 'exist', 'skipOnError' => true, 'targetClass' => JaminanKendaraan::className(), 'targetAttribute' => ['jaminan_kendaraan_id' => 'jaminan_kendaraan_id']],
            [['jaminan_tanah_bangunan_id'], 'exist', 'skipOnError' => true, 'targetClass' => JaminanTanahBangunan::className(), 'targetAttribute' => ['jaminan_tanah_bangunan_id' => 'jaminan_tanah_bangunan_id']],
        ];
    }
